...
public class HttpGetProxy{
	 ...
	 */
	public interface OnLocalURLgetListener{

		String onSuccessResponse(String[] result);
	}
	public void getLocalURL(final String urlString, final OnLocalURLgetListener onLocalURLgetListener) {
		...
		new Thread(){
			...
			public void run() {
				...
				if(onLocalURLgetListener != null){

					onLocalURLgetListener.onSuccessResponse(result);
				}
			}
		}.start();
		// ----排除HTTP特殊----//
