...
import com.ktr.utils.provider.base.BaseContentProvider;
 ...
 */
public class CommonProvider extends BaseContentProvider {

    private static final String TAG = CommonProvider.class.getSimpleName();
    private static final boolean DEBUG = BuildConfig.DEBUG;
    private static final String TYPE_CURSOR_ITEM = "vnd.android.cursor.item/";
    private static final String TYPE_CURSOR_DIR = "vnd.android.cursor.dir/";

    public static final String AUTHORITY = "com.ktr.utils.provider.CommonProvider";
    ...
    protected SQLiteOpenHelper createSqLiteOpenHelper() {
        return CommonSQLiteOpenHelper.getInstance(getContext());
    }
