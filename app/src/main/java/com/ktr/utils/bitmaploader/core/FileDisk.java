...
//		}
//		else
//			Log.d("getInputStream(String key) not exist");
//
//		return null;
//	}
//
...
//
//		Log.d("getOutputStream(String key)" + filePath + File.separator + key + "." + getImageSuffix(url) + ".temp");
//
...
//                Log.v(String.format("原文件已存在不匹配，先删除目标文件，临时文件长度%s, 目标文件长度%s", file.length() + "", newFile.length() + ""));
//                newFile.delete();
//            }
//
