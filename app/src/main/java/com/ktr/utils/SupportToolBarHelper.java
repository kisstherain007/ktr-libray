 ...
 * time : 10:45
 */
public class SupportToolBarHelper {
    ...
    * */
    ...
    public SupportToolBarHelper(Context context, int layoutId) {
    ...
    public SupportToolBarHelper(Context context, View contentView){

        this.mContext = context;
        mUserView = contentView;
        mInflater = LayoutInflater.from(mContext);
        /*初始化整个内容*/
        initContentView();
        /*初始化用户定义的布局*/
        initUserView(mUserView);
        /*初始化toolbar*/
        initToolBar();
    }
