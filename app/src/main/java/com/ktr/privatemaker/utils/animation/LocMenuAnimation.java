package com.ktr.privatemaker.utils.animation;
...
public class LocMenuAnimation {

	private boolean menuShowed;
	
	private static LocMenuAnimation instance = null;
	
	private Animation showAction, hideAction;
	
	public static LocMenuAnimation getInstance(){
		
		if(instance == null){
			
			instance = new LocMenuAnimation();
		}
		
		return instance;
	}
	
	private LocMenuAnimation(){
